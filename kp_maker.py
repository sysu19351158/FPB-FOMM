...
def feature_generator(pic, model):
    ...
    return au_num.requires_grad_(True)
...
root_dir_list = [r"/data1/xu/MIX/train/", r"/data1/xu/MIX/test/"]
...
for root_dir in root_dir_list:
    for i in os.listdir(root_dir):
        ...
        torch.save(feature_generator(img, predictor), os.path.join(r'./keypoint',str(i)+".pt"))
